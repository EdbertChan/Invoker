...
export class SQLiteAdapter implements PersistenceAdapter {
  ...
  private migrate(): void {
    const migrations = [
      ...
      'ALTER TABLE tasks ADD COLUMN remote_heartbeat_at TEXT',
      'ALTER TABLE tasks ADD COLUMN heartbeat_source TEXT',
  ...
  saveTask(workflowId: string, task: TaskState): void {
    ...
    this.execRun(`
      INSERT OR REPLACE INTO tasks (
        ...
        remote_heartbeat_at, heartbeat_source,
    ...
    `, [
      ...
      exec.remoteHeartbeatAt?.toISOString() ?? null,
      exec.heartbeatSource ?? null,
      null,
  ...
  updateTask(taskId: string, changes: TaskStateChanges): void {
    ...
    if (changes.execution) {
      ...
      const execDateMap: Record<string, string> = {
        ...
        remoteHeartbeatAt: 'remote_heartbeat_at',
  ...
  private rowToTask(row: any): TaskState {
    ...
    return {
      ...
      execution: {
        ...
        remoteHeartbeatAt: row.remote_heartbeat_at ? new Date(row.remote_heartbeat_at) : undefined,
        heartbeatSource: row.heartbeat_source ?? undefined,
