...
export async function finalizeHeadlessMutationWithTopup(options: Parameters<typeof finalizeMutationWithGlobalTopup>[0]): ReturnType<typeof finalizeMutationWithGlobalTopup> {
  return finalizeMutationWithGlobalTopup(options);
}

export async function dispatchHeadlessStartedTasksWithTopup(options: Parameters<typeof dispatchStartedTasksWithGlobalTopup>[0]): ReturnType<typeof dispatchStartedTasksWithGlobalTopup> {
  return dispatchStartedTasksWithGlobalTopup(options);
}
