...
export const WORKFLOW_MUTATION_DELEGATION_TIMEOUT_MS = 60_000;
...
export async function resolveDelegationTimeoutMs(args: string[]): Promise<number> {
  ...
  return looksLikeWorkflowId(args[1]) ? WORKFLOW_MUTATION_DELEGATION_TIMEOUT_MS : DEFAULT_DELEGATION_TIMEOUT_MS;
}
