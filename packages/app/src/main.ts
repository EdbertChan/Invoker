...
import { createTaskRunnerWiring } from './execution/task-runner-wiring.js';
import { createWindowLifecycle } from './window/window-lifecycle.js';
...
// ══════════════════════════════════════════════════════════════
  ...
  function rebuildTaskRunner(): void {
    taskExecutor = createTaskRunnerWiring({
      orchestrator,
      persistence,
      executorRegistry,
      executionAgentRegistry: agentRegistry,
  ...
  windowLifecycle.registerSecondInstanceHandler();
  ...
  function onCreateWindowComplete(): void {
    ...
    windowLifecycle.registerActivateHandler();
  }
  ...
  windowLifecycle.registerWindowAllClosedHandler();
