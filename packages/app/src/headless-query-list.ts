...
import { restoreWorkflowForTask } from './headless-shared.js';
...
export async function handleHeadlessQuery(args: string[], deps: HeadlessDeps): Promise<void> {
...
export async function handleHeadlessQuerySelect(taskId: string, deps: Pick<HeadlessDeps, 'persistence'>): Promise<void> {
