...
describe('headless delegation enforcement', () => {
  ...
  describe('owner boundary regression tests', () => {
    ...
    describe('--no-track immediate return', () => {
      ...
      describe('Step 12: workflow-scope routing', () => {
        ...
        it('headless `rebase <taskId>` routes to orchestrator.recreateWorkflowFromFreshBase (first-class Step 12 method)', async () => {
