...
describe('buildInvalidationDeps', () => {
  ...
  it('routes retryTask to orchestrator.retryTask (compat wire for Step 13)', async () => {
  ...
  it('wires recreateWorkflowFromFreshBase to the orchestrator method (Step 12)', async () => {
    const orchestrator = {
  ...
  it('routes workflowFork to orchestrator.forkWorkflow and returns started tasks (Step 14)', async () => {
    const orchestrator = {
      ...makeBaseOrchestrator(),
