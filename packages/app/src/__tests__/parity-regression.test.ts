...
describe('Parity: API endpoints wire to facade methods', () => {
  ...
  const apiWriteCases: Array<{
    ...
    { name: 'POST /api/tasks/:id/select-experiment', method: 'POST', path: '/api/tasks/task-1/select-experiment', body: { experimentId: 'exp-1' }, orchestratorMethod: 'selectExperiment', expectTopup: true },
