...
describe('DELETE /api/workflows/:id', () => {
  it('deletes workflow via facade', async () => {
    const deleteWorkflow = vi.spyOn(mutations, 'deleteWorkflow');
...
describe('POST /api/workflows/:id/detach', () => {
  it('detaches workflow from one upstream workflow', async () => {
    const detachWorkflow = vi.spyOn(mutations, 'detachWorkflow');
    ...
    expect(detachWorkflow).toHaveBeenCalledWith('wf-1', 'wf-0');
