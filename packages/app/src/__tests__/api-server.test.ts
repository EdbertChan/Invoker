...
describe('POST /api/tasks/:id/retry', () => {
  ...
  it('deprecated /restart route returns 404', async () => {
...
describe('POST /api/workflows/:id/recreate-with-rebase', () => {
  it('normalizes merge-node targets to the owning workflow before fresh-base recreate', async () => {
    ...
    const res = await request(port, 'POST', '/api/workflows/__merge__wf-1/recreate-with-rebase');
  ...
  it('deprecated /rebase-and-retry route returns 404', async () => {
...
describe('POST /api/workflows/:id/recreate-with-rebase (additional)', () => {
