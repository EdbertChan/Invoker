...
// ── Startup pipeline (INV-74: layered pipeline modules) ─────
// Extracted to headless-startup.ts to eliminate the duplicated
// create→wire→hook triplet across 14+ headless commands.
import {
...
// ── Startup functions (extracted to headless-startup.ts) ─────
// See headless-startup.ts for: headlessHeartbeat, buildHeadlessApiServerDeps,
// buildHeadlessApproveAction, createHeadlessExecutor, wireHeadlessAutoFix,
// wireHeadlessApproveHook.
