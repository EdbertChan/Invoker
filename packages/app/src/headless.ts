 ...
 *
 * Bootstrap pipeline (TaskRunner factory, auto-fix, approve hook,
 * API-server deps) lives in headless-bootstrap.ts.
 * Business logic (orchestrator mutations) lives in workflow-actions.ts.
 * This file handles CLI parsing, command routing, and output formatting.
 */
...
export { createHeadlessExecutor, wireHeadlessAutoFix, wireHeadlessApproveHook } from './headless-bootstrap.js';
export type { HeadlessDeps, HeadlessAutoFixController } from './headless-bootstrap.js';
