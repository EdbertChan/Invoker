...
import { headlessRun, headlessResume, headlessWatch } from './headless-run-resume.js';
import {
  headlessApprove,
  headlessCancel,
...
import { restoreWorkflowForTask, restoreWorkflowForTaskUnlessDeleteAllWon, withRestoredTaskUnlessDeleteAllWon } from './headless-task-lookup.js';
...
export type { HeadlessDeps } from './headless-types.js';
export { parseQueryFlags } from './headless-query-list.js';
export { resolveAgentSession } from './headless-session-resolver.js';
export { buildHeadlessApiServerDeps, buildHeadlessApproveAction, createHeadlessExecutor, wireHeadlessAutoFix, wireHeadlessApproveHook } from './headless-runtime.js';
export type { HeadlessAutoFixController } from './headless-runtime.js';
