...
export type { HeadlessAutoFixController } from './headless-bootstrap.js';
export {
  delegationTimeoutMs,
  isDelegated,
...
// ── Shared Helpers ───────────────────────────────────────────
// Bootstrap functions (createHeadlessExecutor, wireHeadlessAutoFix,
// wireHeadlessApproveHook, buildHeadlessApiServerDeps,
// buildHeadlessApproveAction) live in headless-bootstrap.ts.
