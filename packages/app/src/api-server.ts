...
export interface ApiServerDeps {
  ...
  /** @deprecated Workflow deletes are API mutations; routes use `mutations.deleteWorkflow`. */
  deleteWorkflow: (workflowId: string) => Promise<void>;
  /** @deprecated Workflow detaches are API mutations; routes use `mutations.detachWorkflow`. */
