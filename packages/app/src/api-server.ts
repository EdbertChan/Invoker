...
export interface ApiServerDeps {
  ...
  /**
   * INV-130 selected design: HTTP handlers parse requests and map errors,
   * while facade methods own mutation + dispatch + topup sequencing.
   */
  mutations: ApiWriteMutations;
