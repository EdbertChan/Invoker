...
export interface ApiServerDeps {
  ...
  /** @deprecated INV-130 routes workflow deletion through `mutations.deleteWorkflow`. */
  deleteWorkflow?: (workflowId: string) => Promise<void>;
  /** @deprecated INV-130 routes workflow detachment through `mutations.detachWorkflow`. */
