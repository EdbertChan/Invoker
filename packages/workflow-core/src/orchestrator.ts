...
export class Orchestrator {
  ...
  private schedulerDomainDeps(): SchedulerDomainDeps {
    return {
      ...
      buildAndPublishUpdateDelta: (before, after, changes) => {
        this.messageBus.publish(TASK_DELTA_CHANNEL, this.buildUpdateDelta(before, after, changes));
      },
  ...
  private transitionDomainDeps(): TransitionDomainDeps {
    return {
      ...
      publishTaskDelta: (delta) => this.messageBus.publish(TASK_DELTA_CHANNEL, delta),
