...
import type { Attempt, ReviewGateExecution, TaskDelta, TaskState, TaskStateChanges } from '@invoker/workflow-graph';
...
export function handleCompletedTransition(
  ...
  try {
    ...
    const currentAttempt = host.loadAttemptById(currentAttemptId);
