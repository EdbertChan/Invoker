...
describe('restartTask deprecation shim', () => {
  ...
  describe('Orchestrator.restartTask', () => {
    ...
    beforeEach(() => {
      ...
      Object.defineProperty(orch, 'logger', { value: loggerStub, writable: true });
      ...
      // Spy on the instance's logger.warn to verify deprecation warnings.
      warnSpy = vi.spyOn(loggerStub, 'warn');
    });
