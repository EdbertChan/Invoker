...
/**
 * First Invoker-managed worktree whose branch parses as the canonical
 * `experiment/<actionId>/<lifecycleTag>-<contentHash>` shape for the same
 * action. Returns the worktree path and branch name.
 */
