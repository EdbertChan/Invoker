 ...
 *
 * Verifies the complete chain: click gate node → TaskPanel shows
 * Approve/Reject buttons → ApprovalModal with context-specific labels.
 * Inline approve buttons were removed from the MergeGateNode.
 */
...
describe('Merge gate approval flow (integration)', () => {
  ...
  it('gate node does not render inline approve button (approval lives in TaskPanel)', async () => {
    render(<App />);
