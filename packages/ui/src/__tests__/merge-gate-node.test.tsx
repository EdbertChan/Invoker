...
describe('MergeGateNode', () => {
  ...
  it('does not render inline approve button for manual merge gate', () => {
    renderNode({
      status: 'awaiting_approval',
      label: 'Plan',
      gateKind: 'merge',
  ...
  it('does not render inline approve button for pull_request gate', () => {
    renderNode({
      status: 'awaiting_approval',
      label: 'Plan',
      gateKind: 'pull_request',
  ...
  it('does not render inline approve button in external_review mode', () => {
    renderNode({
      status: 'awaiting_approval',
      label: 'Plan',
