...
describe('MergeGateNode', () => {
  ...
  it('does not show inline approve button for manual merge gate (approval lives in TaskPanel)', () => {
    renderNode({
      status: 'awaiting_approval',
      label: 'Plan',
      gateKind: 'merge',
  ...
  it('does not show inline approve button for review_ready status', () => {
    renderNode({
      status: 'review_ready',
      label: 'Plan',
      gateKind: 'pull_request',
  ...
  it('does not show inline approve button in external_review mode', () => {
    renderNode({
      status: 'awaiting_approval',
      label: 'Plan',
