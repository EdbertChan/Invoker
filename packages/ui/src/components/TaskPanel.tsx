...
export function TaskPanel({
  ...
  const canEditPrompt = task.config.prompt !== undefined
    && task.status !== 'running'
          ...
          {isEditingCommand && task.config.command !== undefined ? (
            ...
            <div className="mt-2 space-y-2">
              <textarea
                ...
                className="w-full rounded p-3 text-xs text-gray-200 bg-blue-950/40 border border-blue-500 focus:outline-none focus:border-blue-400 resize-y"
                rows={5}
