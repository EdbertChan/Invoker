...
import { TaskRunner, ExecutorRegistry, ReviewProviderRegistry } from '@invoker/execution-engine';
...
export function createTestHarness(opts?: {
  ...
  const executor = new TaskRunner({
    ...
    reviewProviderRegistry: opts?.reviewProviderRegistry ?? new ReviewProviderRegistry(),
  });
