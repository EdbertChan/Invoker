...
# 3. Vitest is available in workspace packages
[ -x packages/contracts/node_modules/.bin/vitest ] || { echo "FAIL: vitest not installed in workspace (run pnpm install)"; exit 1; }
