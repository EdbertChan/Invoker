  ...
  if (raw.visualProof === true) {
    ...
    if (!hasVisualProofTestTask) {
      errors.push({
        ...
        field: 'tasks',
        message: 'Plan has visualProof: true but no task has a prompt referencing "visual-proof.spec.ts" or "captureScreenshot". Add a prompt task that runs the visual proof test.',
      });
    }
    ...
    if (!hasVisualProofCaptureTask) {
      errors.push({
        ...
        field: 'tasks',
        message: 'Plan has visualProof: true but no task has a command referencing "ui-visual-proof.sh". Add a command task that captures visual proof.',
      });
    }
  }
