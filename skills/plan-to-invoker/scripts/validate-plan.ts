  ...
  if (raw.visualProof === true) {
    ...
    if (!hasVisualProofTestTask) {
      errors.push({
        ...
        field: 'tasks',
        message: 'Plan sets visualProof: true but is missing a prompt task for visual-proof.spec.ts or captureScreenshot. Add a prompt task that creates or updates the visual proof test.',
      });
    }
    ...
    if (!hasVisualProofCaptureTask) {
      errors.push({
        ...
        field: 'tasks',
        message: 'Plan sets visualProof: true but is missing a command task for ui-visual-proof.sh. Add a command task that captures visual proof.',
      });
    }
  }
